...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sdk_2fstream_2findex_5fv1_2frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::kaikosdk::StreamIndexServiceRequestV1, event_type_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::kaikosdk::StreamIndexServiceRequestV1)},
};
...
const char descriptor_table_protodef_sdk_2fstream_2findex_5fv1_2frequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "index_code\030\001 \001(\t\022\022\n\nevent_type\030\002 \001(\tB|\n\035"
  "com.kaiko.sdk.stream.index_v1P\001Z\?github."
  "com/challengerdeep/kaiko-go-sdk/stream/i"
  "ndex_v1;index_v1\252\002\027KaikoSdk.Stream.Index"
  "V1b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sdk_2fstream_2findex_5fv1_2frequest_2eproto = {
  false, false, 250, descriptor_table_protodef_sdk_2fstream_2findex_5fv1_2frequest_2eproto, "sdk/stream/index_v1/request.proto", 
  &descriptor_table_sdk_2fstream_2findex_5fv1_2frequest_2eproto_once, nullptr, 0, 1,
...
void StreamIndexServiceRequestV1::SharedCtor() {
index_code_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
event_type_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void StreamIndexServiceRequestV1::SharedDtor() {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "kaikosdk.StreamIndexServiceRequestV1.event_type"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* StreamIndexServiceRequestV1::_InternalSerialize(
  ...
  if (!this->event_type().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "kaikosdk.StreamIndexServiceRequestV1.event_type");
    target = stream->WriteStringMaybeAliased(
...
void StreamIndexServiceRequestV1::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:kaikosdk.StreamIndexServiceRequestV1)
  GOOGLE_DCHECK_NE(&from, this);
  const StreamIndexServiceRequestV1* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StreamIndexServiceRequestV1>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:kaikosdk.StreamIndexServiceRequestV1)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:kaikosdk.StreamIndexServiceRequestV1)
    MergeFrom(*source);
  }
}
...
void StreamIndexServiceRequestV1::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:kaikosdk.StreamIndexServiceRequestV1)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
