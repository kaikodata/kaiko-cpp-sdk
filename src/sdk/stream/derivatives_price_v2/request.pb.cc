...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sdk_2fstream_2fderivatives_5fprice_5fv2_2frequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::kaikosdk::StreamDerivativesPriceRequestV2)},
};
...
::PROTOBUF_NAMESPACE_ID::uint8* StreamDerivativesPriceRequestV2::_InternalSerialize(
