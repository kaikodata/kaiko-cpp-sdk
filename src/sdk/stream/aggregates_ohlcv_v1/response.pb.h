...
class StreamAggregatesOHLCVResponseV1 final :
 ...
 public:
  ...
  inline StreamAggregatesOHLCVResponseV1* New() const final {
    return new StreamAggregatesOHLCVResponseV1();
  }

  StreamAggregatesOHLCVResponseV1* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_close();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_high();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_low();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_open();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_volume();
