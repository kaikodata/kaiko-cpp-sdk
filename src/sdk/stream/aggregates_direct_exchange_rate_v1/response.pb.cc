...
void StreamAggregatesDirectExchangeRateResponseV1::SharedCtor() {
aggregate_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
code_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
price_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
sequence_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void StreamAggregatesDirectExchangeRateResponseV1::SharedDtor() {
...
void StreamAggregatesDirectExchangeRateResponseV1::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:kaikosdk.StreamAggregatesDirectExchangeRateResponseV1)
  GOOGLE_DCHECK_NE(&from, this);
  const StreamAggregatesDirectExchangeRateResponseV1* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StreamAggregatesDirectExchangeRateResponseV1>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:kaikosdk.StreamAggregatesDirectExchangeRateResponseV1)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:kaikosdk.StreamAggregatesDirectExchangeRateResponseV1)
    MergeFrom(*source);
  }
}
...
void StreamAggregatesDirectExchangeRateResponseV1::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:kaikosdk.StreamAggregatesDirectExchangeRateResponseV1)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
