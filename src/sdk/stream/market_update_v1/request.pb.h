...
enum StreamMarketUpdateRequestV1_OrderbookSnapshotType : int {
  ...
  StreamMarketUpdateRequestV1_OrderbookSnapshotType_StreamMarketUpdateRequestV1_OrderbookSnapshotType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  StreamMarketUpdateRequestV1_OrderbookSnapshotType_StreamMarketUpdateRequestV1_OrderbookSnapshotType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class StreamMarketUpdateRequestV1 final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StreamMarketUpdateRequestV1(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StreamMarketUpdateRequestV1* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const StreamMarketUpdateRequestV1& from) {
    StreamMarketUpdateRequestV1::MergeImpl(*this, from);
  }
  private:
...
inline ::kaikosdk::StreamMarketUpdateCommodity StreamMarketUpdateRequestV1::_internal_commodities(int index) const {
  return static_cast< ::kaikosdk::StreamMarketUpdateCommodity >(_impl_.commodities_.Get(index));
}
...
inline ::kaikosdk::StreamMarketUpdateRequestV1_OrderbookSnapshotType StreamMarketUpdateRequestV1::_internal_snapshot_type() const {
  return static_cast< ::kaikosdk::StreamMarketUpdateRequestV1_OrderbookSnapshotType >(_impl_.snapshot_type_);
}
