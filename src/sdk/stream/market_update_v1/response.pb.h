...
enum StreamMarketUpdateResponseV1_StreamMarketUpdateType : int {
  ...
  StreamMarketUpdateResponseV1_StreamMarketUpdateType_FORCE_SNAPSHOT = 8,
  StreamMarketUpdateResponseV1_StreamMarketUpdateType_StreamMarketUpdateResponseV1_StreamMarketUpdateType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  StreamMarketUpdateResponseV1_StreamMarketUpdateType_StreamMarketUpdateResponseV1_StreamMarketUpdateType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class StreamMarketUpdateResponseV1_Snapshot_Order final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StreamMarketUpdateResponseV1_Snapshot_Order(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StreamMarketUpdateResponseV1_Snapshot_Order* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const StreamMarketUpdateResponseV1_Snapshot_Order& from) {
    StreamMarketUpdateResponseV1_Snapshot_Order::MergeImpl(*this, from);
  }
  private:
...
class StreamMarketUpdateResponseV1_Snapshot final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StreamMarketUpdateResponseV1_Snapshot(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StreamMarketUpdateResponseV1_Snapshot* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const StreamMarketUpdateResponseV1_Snapshot& from) {
    StreamMarketUpdateResponseV1_Snapshot::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class StreamMarketUpdateResponseV1 final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StreamMarketUpdateResponseV1(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StreamMarketUpdateResponseV1* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const StreamMarketUpdateResponseV1& from) {
    StreamMarketUpdateResponseV1::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  static constexpr StreamMarketUpdateType FORCE_SNAPSHOT =
    StreamMarketUpdateResponseV1_StreamMarketUpdateType_FORCE_SNAPSHOT;
  ...
  PROTOBUF_NODISCARD ::kaikosdk::StreamMarketUpdateResponseV1_Snapshot* release_snapshot();
...
inline ::kaikosdk::StreamMarketUpdateCommodity StreamMarketUpdateResponseV1::_internal_commodity() const {
  return static_cast< ::kaikosdk::StreamMarketUpdateCommodity >(_impl_.commodity_);
}
...
inline ::kaikosdk::StreamMarketUpdateResponseV1_StreamMarketUpdateType StreamMarketUpdateResponseV1::_internal_update_type() const {
  return static_cast< ::kaikosdk::StreamMarketUpdateResponseV1_StreamMarketUpdateType >(_impl_.update_type_);
}
...
inline const ::kaikosdk::StreamMarketUpdateResponseV1_Snapshot& StreamMarketUpdateResponseV1::_internal_snapshot() const {
  const ::kaikosdk::StreamMarketUpdateResponseV1_Snapshot* p = _impl_.snapshot_;
...
inline ::kaikosdk::StreamMarketUpdateResponseV1_Snapshot* StreamMarketUpdateResponseV1::release_snapshot() {
  ...
  ::kaikosdk::StreamMarketUpdateResponseV1_Snapshot* temp = _impl_.snapshot_;
  _impl_.snapshot_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
