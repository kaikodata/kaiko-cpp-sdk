...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sdk_2fcore_2fwrappers_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::kaikosdk::TimestampValue)},
};
...
void TimestampValue::SharedCtor() {
value_ = nullptr;
}
...
void TimestampValue::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* TimestampValue::_InternalSerialize(
...
void TimestampValue::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:kaikosdk.TimestampValue)
  GOOGLE_DCHECK_NE(&from, this);
  const TimestampValue* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TimestampValue>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:kaikosdk.TimestampValue)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:kaikosdk.TimestampValue)
    MergeFrom(*source);
  }
}
...
void TimestampValue::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:kaikosdk.TimestampValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
