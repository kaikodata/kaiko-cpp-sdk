...
class SourceData final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_exchange_code();
...
inline std::string* SourceData::mutable_exchange_code() {
  ...
  return _internal_mutable_exchange_code();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SourceData::_internal_count() const {
  return count_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SourceData::count() const {
  // @@protoc_insertion_point(field_get:kaikosdk.SourceData.count)
  return _internal_count();
}
inline void SourceData::_internal_set_count(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  count_ = value;
}
inline void SourceData::set_count(::PROTOBUF_NAMESPACE_ID::int64 value) {
