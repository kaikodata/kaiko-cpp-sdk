...
class InstrumentCriteria final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR InstrumentCriteria(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  InstrumentCriteria* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const InstrumentCriteria& from) {
    InstrumentCriteria::MergeImpl(*this, from);
  }
  private:
