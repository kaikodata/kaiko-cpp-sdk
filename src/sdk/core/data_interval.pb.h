...
class DataInterval final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR DataInterval(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DataInterval* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DataInterval& from) {
    DataInterval::MergeImpl(*this, from);
  }
  private:
