...
class StreamDerivativesPriceServiceV2 final {
 public:
  static constexpr char const* service_full_name() {
    return "kaikosdk.StreamDerivativesPriceServiceV2";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    // Subscribe
    std::unique_ptr< ::grpc::ClientReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>> Subscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>>(SubscribeRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>> AsyncSubscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>>(AsyncSubscribeRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>> PrepareAsyncSubscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::kaikosdk::StreamDerivativesPriceResponseV2>>(PrepareAsyncSubscribeRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      // Subscribe
      virtual void Subscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2* request, ::grpc::ClientReadReactor< ::kaikosdk::StreamDerivativesPriceResponseV2>* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
  ...
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    std::unique_ptr< ::grpc::ClientReader< ::kaikosdk::StreamDerivativesPriceResponseV2>> Subscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::kaikosdk::StreamDerivativesPriceResponseV2>>(SubscribeRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>> AsyncSubscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>>(AsyncSubscribeRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>> PrepareAsyncSubscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>>(PrepareAsyncSubscribeRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void Subscribe(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2* request, ::grpc::ClientReadReactor< ::kaikosdk::StreamDerivativesPriceResponseV2>* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientReader< ::kaikosdk::StreamDerivativesPriceResponseV2>* SubscribeRaw(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request) override;
    ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>* AsyncSubscribeRaw(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::kaikosdk::StreamDerivativesPriceResponseV2>* PrepareAsyncSubscribeRaw(::grpc::ClientContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2& request, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_Subscribe_;
  };
  static std::unique_ptr<Stub> NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ~Service();
    // Subscribe
    virtual ::grpc::Status Subscribe(::grpc::ServerContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2* request, ::grpc::ServerWriter< ::kaikosdk::StreamDerivativesPriceResponseV2>* writer);
  };
  template <class BaseClass>
  class WithAsyncMethod_Subscribe : public BaseClass {
   private:
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status Subscribe(::grpc::ServerContext* /*context*/, const ::kaikosdk::StreamDerivativesPriceRequestV2* /*request*/, ::grpc::ServerWriter< ::kaikosdk::StreamDerivativesPriceResponseV2>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestSubscribe(::grpc::ServerContext* context, ::kaikosdk::StreamDerivativesPriceRequestV2* request, ::grpc::ServerAsyncWriter< ::kaikosdk::StreamDerivativesPriceResponseV2>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncServerStreaming(0, context, request, writer, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_Subscribe<Service > AsyncService;
  ...
  class WithCallbackMethod_Subscribe : public BaseClass {
   ...
   public:
    WithCallbackMethod_Subscribe() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackServerStreamingHandler< ::kaikosdk::StreamDerivativesPriceRequestV2, ::kaikosdk::StreamDerivativesPriceResponseV2>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::kaikosdk::StreamDerivativesPriceRequestV2* request) { return this->Subscribe(context, request); }));
    }
    ~WithCallbackMethod_Subscribe() override {
      BaseClassMustBeDerivedFromService(this);
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::kaikosdk::StreamDerivativesPriceResponseV2>* Subscribe(
      ::grpc::CallbackServerContext* /*context*/, const ::kaikosdk::StreamDerivativesPriceRequestV2* /*request*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_Subscribe<Service > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  class WithSplitStreamingMethod_Subscribe : public BaseClass {
   ...
   public:
    WithSplitStreamingMethod_Subscribe() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::SplitServerStreamingHandler<
          ::kaikosdk::StreamDerivativesPriceRequestV2, ::kaikosdk::StreamDerivativesPriceResponseV2>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerSplitStreamer<
                     ::kaikosdk::StreamDerivativesPriceRequestV2, ::kaikosdk::StreamDerivativesPriceResponseV2>* streamer) {
                       return this->StreamedSubscribe(context,
                         streamer);
                  }));
    }
    ...
    // replace default version of method with split streamed
    virtual ::grpc::Status StreamedSubscribe(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::kaikosdk::StreamDerivativesPriceRequestV2,::kaikosdk::StreamDerivativesPriceResponseV2>* server_split_streamer) = 0;
  };
  typedef WithSplitStreamingMethod_Subscribe<Service > SplitStreamedService;
  typedef WithSplitStreamingMethod_Subscribe<Service > StreamedService;
};
